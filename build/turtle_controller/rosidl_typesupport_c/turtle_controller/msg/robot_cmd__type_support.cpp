...
static const _RobotCmd_type_support_symbol_names_t _RobotCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_controller, msg, RobotCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtle_controller, msg, RobotCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtle_controller, msg, RobotCmd)() {
  return &::turtle_controller::msg::rosidl_typesupport_c::RobotCmd_message_type_support_handle;
}
