...
#include "turtle_controller/msg/detail/directional_distance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_controller::msg::DirectionalDistance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_controller::msg::DirectionalDistance & ros_message)
{
  // Member: front
  cdr >> ros_message.front;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_controller::msg::DirectionalDistance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_controller::msg::DirectionalDistance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_controller::msg::DirectionalDistance *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DirectionalDistance__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtle_controller::msg::DirectionalDistance *>(
...
static size_t _DirectionalDistance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DirectionalDistance(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DirectionalDistance__callbacks = {
...
static rosidl_message_type_support_t _DirectionalDistance__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DirectionalDistance__callbacks,
...
{
  return &turtle_controller::msg::typesupport_fastrtps_cpp::_DirectionalDistance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_controller, msg, DirectionalDistance)() {
  return &turtle_controller::msg::typesupport_fastrtps_cpp::_DirectionalDistance__handle;
}
