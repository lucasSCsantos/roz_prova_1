...
static const _DirectionalDistance_type_support_symbol_names_t _DirectionalDistance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_controller, msg, DirectionalDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_controller, msg, DirectionalDistance)),
  }
};
...
{
  return &::turtle_controller::msg::rosidl_typesupport_cpp::DirectionalDistance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_controller, msg, DirectionalDistance)() {
  return get_message_type_support_handle<turtle_controller::msg::DirectionalDistance>();
}
