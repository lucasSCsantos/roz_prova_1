...
: ${AMENT_CURRENT_PREFIX:="/home/aula-robotica/ros_ws/install/turtle_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/turtle_controller/environment/library_path.sh"
